...
public class DeactivateUserTest extends BaseTest {
	...
	public void deactivateUserTest() throws InterruptedException {
		logger.info("Starting to deactivate user..");
        ...
        userMngmtPage.deactivateAccount();
		logger.info("User:" +PREFFNAME+ "is deactivated successfully");
	}
